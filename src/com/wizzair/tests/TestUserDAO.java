...
public class TestUserDAO {
	...
	public void test() throws Exception {
		...
		Passanger passanger = new Passanger("mirela", "vlaeva", Gender.FEMALE, CabinBaggage.LARGE,
				ChechedInBaggage.HEAVY, true, true, "8A");

		Ticket ticket = new Ticket(passanger, "2783462", "2342", LocalDate.now(), LocalDate.now());
		...
		new UserDAO().buyTicket(ticket, new User("m.mihalcheva", "mirelaA1"), passangers);
	}
}